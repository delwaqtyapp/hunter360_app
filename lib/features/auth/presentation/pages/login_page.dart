...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  Future<void> _uploadLicense() async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Invalid license file: $e'), backgroundColor: Colors.red),
        );
      }
    }
  }
    ...
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xFF0D3B4F), Color(0xFF156082), Color(0xFF1B5E20)]),
        ),
        child: SafeArea(
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: ClipOval(
                    child: Image.asset('assets/images/logo_hunter.png', width: 120, height: 120, fit: BoxFit.cover,
                      errorBuilder: (ctx, e, s) => const Icon(Icons.water_drop, size: 60, color: Colors.white)),
                  ),
                ),
                const SizedBox(height: 16),
                const Text('ABQARINO', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold, letterSpacing: 4)),
                const Text('SCADA', style: TextStyle(color: Color(0xFFFFC107), fontSize: 40, fontWeight: FontWeight.bold)),
                const SizedBox(height: 4),
                Text(l10n.poweredBy, style: TextStyle(color: Colors.white.withOpacity(0.7), fontSize: 12)),
                const SizedBox(height: 40),
                Container(
                  padding: const EdgeInsets.all(24),
                  ...
                  child: Column(
                    children: [
                      Text(l10n.login, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF156082))),
                      const SizedBox(height: 24),
                      TextField(
                        controller: _usernameController,
                        decoration: InputDecoration(
                          labelText: l10n.username,
                          prefixIcon: const Icon(Icons.person, color: Color(0xFF156082)),
                          border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
                          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFF156082))),
                        ),
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.lock, color: Color(0xFF156082)),
                      ...
                      GestureDetector(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(l10n.serverConfig, style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
                      ...
                      if (_showServerConfig) ...[
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: const Icon(Icons.dns, color: Color(0xFF156082)),
                            border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
                            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFF156082))),
                          ),
                        ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: authState.status == AuthStatus.loading
                              ...
                              : Text(l10n.signIn, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, letterSpacing: 2)),
                        ),
                      ),
                    ],
                  ),
                ...
                const SizedBox(height: 16),
                Text('${l10n.version} ${AppConstants.version}', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 11)),
              ],
            ),
          ),
        ),
